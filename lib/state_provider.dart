...
class StateProvider with ChangeNotifier {
  ...
  bool get itemAdderRefresh => _itemAdderRefresh;
  ...
  void itemAdderRefreshTrue() {
    _itemAdderRefresh = true;
    notifyListeners();
  }

  void itemAdderRefreshFalse() {
    _itemAdderRefresh = false;
    notifyListeners();
  }
