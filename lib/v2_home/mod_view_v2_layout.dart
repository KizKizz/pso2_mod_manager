...
class _ModViewV2LayoutState extends State<ModViewV2Layout> {
  ...
  Widget build(BuildContext context) {
    ...
    if (itemListSearchIncludesMods && displayingSubmodCards.isEmpty) {
      displayingSubmodCards = widget.mod.submods
          .map((e) => SubmodCardLayout(
                item: widget.item,
                mod: widget.mod,
                submod: e,
    ...
    if (displayingSubmodCards.isNotEmpty) {
      ...
      return SliverPadding(padding: EdgeInsetsGeometry.zero);
    }
  }
}
