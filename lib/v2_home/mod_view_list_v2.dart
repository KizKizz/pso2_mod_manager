...
class _ModViewListV2State extends State<ModViewListV2> {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedDisplaySortModView.value == modSortingSelections[0]) {
      ...
      filteredMods.sort(
        (a, b) => b.submods.length.compareTo(a.submods.length) == 0
      ...
      filteredMods.sort(
        (a, b) => a.submods.length.compareTo(b.submods.length) == 0
      ...
      return SizedBox(
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Center(
              child: Text(appText.emptyModViewInfo, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleMedium),
            ),
          ),
        ),
      );
                  ...
                  children: [
                    ...
                    if (itemEditingMode)
                      SizedBox(
                        width: double.infinity,
                        height: 31,
                        child: ModBulkDeleteButton(enabled: bulkDeleteMods.isNotEmpty || bulkDeleteSubmods.isNotEmpty, isPopup: false),
                      ),
                  ],
                ),
              ),
