...
class _HomepageV2State extends State<HomepageV2> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiSplitViewTheme(
        data: MultiSplitViewThemeData(dividerPainter: DividerPainters.grooved2(count: 49, highlightedCount: 99, highlightedColor: Theme.of(context).colorScheme.primaryContainer)), child: multiSplitView);
  }
}
