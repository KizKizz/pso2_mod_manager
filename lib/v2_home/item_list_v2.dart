          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Expanded(child: Text(appText.itemList, style: Theme.of(context).textTheme.titleMedium)),
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: IconButton.outlined(
                          ...
                          icon: Icon(displayingCategories.indexWhere((e) => e.visible) != -1 ? Icons.drag_handle_sharp : Icons.expand_outlined),
                        ),
                      ),
                    ],
                  ),
                          ...
                          onSearchTextChanged: (p0) {
                            ...
                            if (itemListSearchIncludesMods) {
                              ...
                              for (var item in filteredItems) {
                                if (suggestionNames.indexWhere((e) => e.toLowerCase() == item.itemName.toLowerCase()) == -1 && item.itemName.toLowerCase().contains(searchTextController.value.text)) {
