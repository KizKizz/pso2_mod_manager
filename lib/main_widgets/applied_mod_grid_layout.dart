      ...
      for (var item in widget.category.items.where((e) => e.applyStatus)) {
        for (var mod in item.mods.where((e) => e.applyStatus)) {
          for (var submod in mod.submods.where((e) => e.applyStatus)) {
            modCardList.add(ModCardLayout(item: item, mod: mod, submod: submod));
          }
        }
      }
    } else {
    ...
    return CardOverlay(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: ModManTooltip(
              message: '${widget.mod.modName}  \u{25B6}  ${widget.submod.submodName}',
              child: Row(
                spacing: 2.5,
                ...
                children: [
                  Flexible(
                    child: Text(widget.mod.modName, textAlign: TextAlign.center, style: Theme.of(context).textTheme.labelLarge),
                  ),
