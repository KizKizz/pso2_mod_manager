...
class CateModGridLayout extends SignalStatefulWidget {
...
class _CateModGridLayoutState extends State<CateModGridLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedDisplaySort.value == modSortingSelections[0]) {
      allMods.sort(
        (a, b) => a.$2.favoriteSort().compareTo(b.$2.favoriteSort()) == 0
      ...
      allMods.sort(
        (a, b) => a.$2.hasPreviewsSort().compareTo(b.$2.hasPreviewsSort()) == 0
      ...
      allMods.sort(
        (a, b) => b.$2.creationDate!.compareTo(a.$2.creationDate!) == 0
      ...
      allMods.sort(
        (a, b) => b.$2.applyDate.compareTo(a.$2.applyDate) == 0
      ...
      allMods.sort(
        (a, b) => b.$2.submods.length.compareTo(a.$2.submods.length) == 0
      ...
      allMods.sort(
        (a, b) => a.$2.submods.length.compareTo(b.$2.submods.length) == 0
      ...
      sliver: SliverStickyHeader.builder(
        ...
        builder: (context, status) => InkWell(
          onTap: () {
            ...
            widget.itemCate.visible ? mainGridStatus.value = '[${DateTime.now()}] ${widget.itemCate.categoryName} is collapsed' : mainGridStatus.value = '${widget.itemCate.categoryName} is expanded';
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(widget.item.getDisplayName(), textAlign: TextAlign.center, style: Theme.of(context).textTheme.labelLarge),
                        ),
                      ],
                    ),
                  ),
              ...
              Expanded(
                child: Center(
                  child: ModManTooltip(
                    message: widget.mod.modName,
                    child: AutoSizeText(widget.mod.modName, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, maxLines: 1, style: Theme.of(context).textTheme.labelLarge),
                  ),
                ),
              ),
              Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: InfoBox(info: appText.dText(widget.mod.submods.length > 1 ? appText.numVariants : appText.numVariant, widget.mod.submods.length.toString()), borderHighlight: false),
                      ),
                      if (widget.mod.isFavorite) FavoriteBox(),
                    ],
                  ),
                  InfoBox(info: appText.dText(appText.numCurrentlyApplied, widget.mod.getNumOfAppliedSubmods().toString()), borderHighlight: widget.mod.applyStatus),
