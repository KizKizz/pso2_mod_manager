...
class SubmodGridLayout extends StatefulWidget {
  const SubmodGridLayout({
    ...
    required this.item,
    required this.mod,
    required this.submods,
    required this.searchString,
    required this.modSetName,
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Visibility(
                            visible: widget.submod.hasCmx!,
                            child: InfoTag(info: appText.cmx, borderHighlight: widget.submod.cmxApplied!),
                          ),
                          Visibility(
                            visible: widget.submod.customAQMInjected!,
                            child: ModManTooltip(
                              message: widget.submod.customAQMFileName!,
                              child: InfoTag(info: appText.aqm, borderHighlight: widget.submod.customAQMInjected!),
                            ),
                          ),
                          Visibility(
                            visible: widget.submod.boundingRemoved!,
                            child: InfoTag(info: appText.bounding, borderHighlight: widget.submod.boundingRemoved!),
                          ),
                        ],
                      ),
                    ),
              ...
              Expanded(
                child: Center(
                  child: ModManTooltip(
                    message: widget.showModName != null && widget.showModName! ? '${widget.submod.modName}  \u{25B6}  ${widget.submod.submodName}' : widget.submod.submodName,
                    child: AutoSizeText(
                      widget.showModName != null && widget.showModName! ? '${widget.submod.modName}  \u{25B6}  ${widget.submod.submodName}' : widget.submod.submodName,
              ...
              Row(
                ...
                children: [
                      ...
                      child: IconButton.outlined(
                        ...
                        onPressed: !widget.submod.activeInSets!.contains(widget.modSetName)
                            ? () {
                                ...
                                modSetRefreshSignal.value = modPopupStatus.value =
                                    '[${DateTime.now()}] "${widget.modSetName}" active submod changed to "${widget.submod.submodName}" in "${widget.item.getDisplayName()}"';
                                saveMasterModListToJson();
                                saveMasterModSetListToJson();
                              }
                            : null,
                        icon: Icon(
                          widget.submod.activeInSets!.contains(widget.modSetName) ? Icons.check_box_outlined : Icons.check_box_outline_blank_rounded,
                  ...
                  IconButton.outlined(
                    visualDensity: VisualDensity.adaptivePlatformDensity,
                    onPressed: () => modFileListPopup(context, widget.item, widget.mod, widget.submod),
