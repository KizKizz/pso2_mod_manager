...
Future<void> _multiChoiceSelectPopup(
  context,
  String selectPopupLabel,
  List<String> availableItemList,
  List<String> availableItemLabels,
  Signal<List<String>> selectedItems,
      ...
      return StatefulBuilder(
        builder: (dialogContext, setState) {
          return AlertDialog(
            ...
            title: Column(
              children: [
                Text(selectPopupLabel, style: TextStyle(color: Theme.of(context).colorScheme.primary)),
                const HoriDivider(),
              ],
            ),
