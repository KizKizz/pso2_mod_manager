      ...
      return StatefulBuilder(
        builder: (dialogContext, setState) {
          return AlertDialog(
            ...
            title: Column(
              children: [
                Text('Mods Apply Delay', style: TextStyle(color: Theme.of(context).colorScheme.primary)),
                const HoriDivider(),
              ],
            ),
            ...
            content: Column(
              ...
              children: [
                Text('Current value: ${popupAfterDismissWaitDelayMilli.toString()} milliseconds', style: TextStyle(color: Theme.of(context).colorScheme.primary)),
                Form(
                  key: nameFormKey,
                  child: TextFormField(
                    controller: newDelay,
