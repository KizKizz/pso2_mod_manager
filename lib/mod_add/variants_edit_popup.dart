      ...
      return StatefulBuilder(
        builder: (dialogContext, setState) {
          ...
          return AlertDialog(
            ...
            title: Column(
              children: [
                Text(p.basename(addingMod.modDir.path), style: TextStyle(color: Theme.of(context).colorScheme.primary)),
                const HoriDivider(),
              ],
            ),
                            ...
                            Row(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  icon: Icon(
                                    addingMod.aItemAddingStates[0] ? Icons.check_box_outlined : Icons.check_box_outline_blank,
                                ...
                                Visibility(
                                  ...
                                  child: IconButton(
                                    onPressed: () async {
                                      ...
                                      if (newName != null) {
                                        addingMod.associatedItems[0] = ItemData(
                                          '',
                                          '',
                                          '',
                                          ['Misc'],
                                          ...
                                          13,
                                          '',
                                          Map.fromEntries([MapEntry('Japanese Name', newName), MapEntry('English Name', newName)]),
                                        );
                                        setState(() {});
                                      }
                                    },
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                            onPressed: addingMod.submods.length > 1 && addingMod.submodAddingStates.where((e) => e == true).length > 1 || !addingMod.submodAddingStates[i]
                                                ...
                                                : null,
                                            icon: Icon(
                                              addingMod.submodAddingStates[i] ? Icons.check_box_outlined : Icons.check_box_outline_blank,
