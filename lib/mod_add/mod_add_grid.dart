                            ...
                            children: [
                              ...
                              Expanded(
                                child: ModManTooltip(
                                  ...
                                  child: InfoBox(info: appText.dText(appText.numItemSelected, modAddingList[i].submodAddingStates.where((e) => e == true).length.toString()), borderHighlight: false),
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              Expanded(
                                child: OutlinedButton(
                                  ...
                                  child: Text(appText.editVariants, textAlign: TextAlign.center),
                                ),
                              ),
                              IconButton(
                                onPressed: () async {
                              ...
                              IconButton(
                                ...
                                icon: Icon(
                                  modAddingList[i].aItemAddingStates[0] ? Icons.check_box_outlined : Icons.check_box_outline_blank,
