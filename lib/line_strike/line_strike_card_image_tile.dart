...
class LineStrikeCardCustomImageTile extends StatefulWidget {
  const LineStrikeCardCustomImageTile({super.key, required this.customImageFile, required this.onDeleteButtonPress});

  final File customImageFile;
  final VoidCallback onDeleteButtonPress;

  @override
  State<LineStrikeCardCustomImageTile> createState() => _LineStrikeCardCustomImageTileState();
}

class _LineStrikeCardCustomImageTileState extends State<LineStrikeCardCustomImageTile> {
  @override
