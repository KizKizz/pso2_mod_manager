...
Future<bool> lineStrikeSleeveRestorePopup(context, LineStrikeSleeve sleeve, List<LineStrikeSleeve> lineStrikeSleeveList) async {
  bool? taskFinished;
  final Future future = customSleeveImageRemove(sleeve, lineStrikeSleeveList);
            ...
            content: FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState != ConnectionState.done) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(appText.dText(appText.restoringFile, sleeve.iceDdsName), style: Theme.of(context).textTheme.bodyLarge),
                              ),
                            ],
                          ),
                        ),
                  ...
                  return FutureBuilderError(loadingText: appText.dText(appText.restoringFile, sleeve.iceDdsName), snapshotError: snapshot.error.toString(), isPopup: true, showContButton: false);
                } else {
