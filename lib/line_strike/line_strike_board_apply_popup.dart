            ...
            content: FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState != ConnectionState.done) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(appText.dText(appText.editingMod, board.iceDdsName), style: Theme.of(context).textTheme.bodyLarge),
                              ),
                            ],
                          ),
                        ),
                  ...
                  return FutureBuilderError(loadingText: appText.dText(appText.editingMod, board.iceDdsName), snapshotError: snapshot.error.toString(), isPopup: true, showContButton: false);
                } else {
