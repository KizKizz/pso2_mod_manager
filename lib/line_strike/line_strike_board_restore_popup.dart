...
Future<bool> lineStrikeBoardRestorePopup(context, LineStrikeBoard board, List<LineStrikeBoard> lineStrikeBoardList) async {
  bool? taskFinished;
  final Future future = customBoardImageRemove(board, lineStrikeBoardList);
            ...
            content: FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState != ConnectionState.done) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(appText.dText(appText.restoringFile, board.iceDdsName), style: Theme.of(context).textTheme.bodyLarge),
                              ),
                            ],
                          ),
                        ),
                  ...
                  return FutureBuilderError(loadingText: appText.dText(appText.restoringFile, board.iceDdsName), snapshotError: snapshot.error.toString(), isPopup: true, showContButton: false);
                } else {
