              ...
              content: FutureBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  if (snapshot.connectionState != ConnectionState.done) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  appText.dText(appText.editingMod, sleeve.iceDdsName),
                    ...
                    return FutureBuilderError(loadingText: appText.dText(appText.editingMod, sleeve.iceDdsName), snapshotError: snapshot.error.toString());
                  } else {
