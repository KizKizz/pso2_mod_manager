...
Future<bool> lineStrikeCardApplyPopup(context, String customImagePath, LineStrikeCard card) async {
  bool? taskFinished;
  final Future future = customImageApply(context, customImagePath, card);
            ...
            content: FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState != ConnectionState.done) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(appText.dText(appText.editingMod, card.cardZeroDdsName), style: Theme.of(context).textTheme.bodyLarge),
                              ),
                            ],
                          ),
                        ),
                  ...
                  return FutureBuilderError(loadingText: appText.dText(appText.editingMod, card.cardZeroDdsName), snapshotError: snapshot.error.toString(), isPopup: true, showContButton: false);
                } else {
