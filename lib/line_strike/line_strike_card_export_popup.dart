            ...
            content: FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState != ConnectionState.done) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(appText.dText(appText.exportingFile, card.cardZeroDdsName), style: Theme.of(context).textTheme.bodyLarge),
                              ),
                            ],
                          ),
                        ),
                  ...
                  return FutureBuilderError(loadingText: appText.dText(appText.exportingFile, card.cardZeroDdsName), snapshotError: snapshot.error.toString(), isPopup: true, showContButton: false);
                } else {
                  ...
                  return ConstrainedBox(
                    ...
                    child: CardOverlay(
                      ...
                      child: Column(
                        ...
                        children: [
                          SignalBuilder(
                            builder: (context) => Text(lineStrikeStatus.value, textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodyLarge),
                          ),
                          const HoriDivider(),
                          Row(
                            spacing: 5,
