          ...
          return AlertDialog(
            ...
            content: Form(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (Directory(exportedModsDirPath).existsSync() &&
                      Directory(exportedModsDirPath).listSync().whereType<File>().toList().indexWhere((e) => p.basenameWithoutExtension(e.path).toLowerCase() == newName.value.text.toLowerCase()) !=
                          -1) {
                ...
                decoration: InputDecoration(
                    labelText: appText.enterANameToExport,
