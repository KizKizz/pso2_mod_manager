                              ...
                              Padding(
                                ...
                                child: Container(
                                    ...
                                    child: cateList[index].numOfItems < 2
                                        ? Text(
                                            '${cateList[index].numOfItems} Item',
                                            style: const TextStyle(
                                              fontSize: 13,
                                            ))
                                        : Text(
                                            '${cateList[index].numOfItems} Items',
                                            style: const TextStyle(
                                              fontSize: 13,
                                            ))),
                              ),
                          ...
                          Row(
                            children: [
                              if (cateList[index].categoryName != 'Favorites')
                                Tooltip(
                                    message:
                                        'Remove ${cateList[index].categoryName}',
                                    height: 25,
                                    textStyle: TextStyle(
                                        fontSize: 15,
                              ...
                              child: ListTile(
                                ...
                                trailing: Wrap(
                                  children: [
                                    ...
                                    Tooltip(
                                        message:
                                            'Open ${cateList[index].itemNames[i]} in File Explorer',
                                        height: 25,
                                        textStyle: TextStyle(
                                            fontSize: 15,
                                            color:
                                    ...
                                    if (cateList[index].categoryName ==
                                      ...
                                      SizedBox(
                                        ...
                                        child: Tooltip(
                                          message:
                                              'Remove "${cateList[index].itemNames[i]}" from favorites',
                                          height: 25,
                                          textStyle: TextStyle(
                                              fontSize: 15,
                          ...
                          for (int i = 0;
                            ...
                            Ink(
                              ...
                              child: ListTile(
                                ...
                                title: Text(cateList[index].itemNames[i]),
                                subtitle: Text(
                                    'Mods: ${cateList[index].numOfMods[i]} | Files Applied: ${cateList[index].numOfApplied[i]}'),
                                trailing: Wrap(
                                  children: [
                                    if (cateList[index].allModFiles.indexWhere(
                                            (element) =>
                                    ...
                                    Tooltip(
                                        message:
                                            'Delete ${cateList[index].itemNames[i]}',
                                        height: 25,
                                        textStyle: TextStyle(
                                            fontSize: 15,
                                            color:
                                                ...
                                                setState(() {
                                                  if (cateList[index]
                                                    ...
                                                    itemDeleteDialog(
                                                        ...
                                                        popupHeight,
                                                        'Delete Item',
                                                        'Cannot delete "${cateList[index].itemNames[i]}". Remove from Favorites first',
                                                        false,
                                                        cateList[index],
                                                        cateList[index]
                                                            .itemNames[i],
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                    ...
                                    child: Text(
                                        '${cateListSearchResult[index].numOfItems} Items',
                                        style: const TextStyle(
                                          fontSize: 13,
                                        ))),
                              ),
                          ...
                          for (int i = 0;
                            ...
                            Ink(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                    'Mods: ${cateListSearchResult[index].numOfMods[i]} | Applied: ${cateListSearchResult[index].numOfApplied[i]}'),
                                trailing: Wrap(
                                  children: [
                                    ...
                                    Tooltip(
                                        message:
                                            'Open ${cateListSearchResult[index].itemNames[i]} in File Explorer',
                                        height: 25,
                                        textStyle: TextStyle(
                                            fontSize: 15,
                                            color:
                                    ...
                                    if (cateListSearchResult[index]
                                      ...
                                      SizedBox(
                                        ...
                                        child: Tooltip(
                                          message:
                                              'Remove "${cateListSearchResult[index].itemNames[i]}" from favorites',
                                          height: 25,
                                          textStyle: TextStyle(
                                              fontSize: 15,
                                              color: Theme.of(context)
                            ...
                            Ink(
                              ...
                              child: ListTile(
                                ...
                                title: Text(
                                    cateListSearchResult[index].itemNames[i]),
                                subtitle: Text(
                                    'Mods: ${cateListSearchResult[index].numOfMods[i]} | Files applied: ${cateListSearchResult[index].numOfApplied[i]}'),
                                trailing: Wrap(
                                  children: [
                                    if (cateListSearchResult[index]
                                            .allModFiles
                                    ...
                                    Tooltip(
                                        message:
                                            'Delete ${cateListSearchResult[index].itemNames[i]}',
                                        height: 25,
                                        textStyle: TextStyle(
                                            fontSize: 15,
                                            color:
                                                ...
                                                setState(() {
                                                  if (cateListSearchResult[
                                                    ...
                                                    itemDeleteDialog(
                                                        ...
                                                        popupHeight,
                                                        'Delete Item',
                                                        'Cannot delete "${cateListSearchResult[index].itemNames[i]}". Remove from Favorites first',
                                                        false,
                                                        cateListSearchResult[
                                                            index],
                                                        cateListSearchResult[
          ...
          actions: [
            Tooltip(
                message: modsViewAppBarName == '' ||
                        modsViewAppBarName == 'Available Mods'
                    ? 'Add Mods'
                    : 'Add Mods To $modsViewAppBarName',
                height: 25,
                textStyle: TextStyle(
                    fontSize: 15, color: Theme.of(context).canvasColor),
                waitDuration: const Duration(seconds: 1),
                                                    ...
                                                    children: [
                                                      ...
                                                      if (modFilesList[index].indexWhere(
                                                        ...
                                                        SizedBox(
                                                          ...
                                                          child: Tooltip(
                                                            message:
                                                                'Remove all mods under "$modsViewAppBarName ${modFilesList[index].first.iceParent}" from the game',
                                                            height: 25,
                                                            textStyle: TextStyle(
                                                                fontSize: 15,
                                                                color: Theme.of(
                                                                        ...
                                                                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                            ...
                                                                            content: SizedBox(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  for (int i = 0; i < originalFilesMissingList.length; i++) Text('Original file of "${originalFilesMissingList[i].modName} ${originalFilesMissingList[i].iceParent} > ${originalFilesMissingList[i].iceName}" is not found'),
                                                                                ],
                                                                              ),
                                                                            )));
                                                                      }
                                                                        ...
                                                                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                            ...
                                                                            content: SizedBox(
                                                                              ...
                                                                              child: Column(
                                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                                children: [
                                                                                  for (int i = 0; i < modAppliedDup.length; i++) Text('Replaced: ${modAppliedDup[i].categoryName} > ${modAppliedDup[i].modName} ${modAppliedDup[i].iceParent} > ${modAppliedDup[i].iceName}'),
                                                                                ],
                                                                              ),
                                                                            )));
                                                                        modAppliedDup
                                                      ...
                                                      if (!isViewingFav)
                                                        Tooltip(
                                                            message:
                                                                'Delete $modsViewAppBarName ${modFilesList[index].first.iceParent}',
                                                            height: 25,
                                                            textStyle: TextStyle(
                                                                fontSize: 15,
                                                                color: Theme.of(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          if (modFilesList[index].indexWhere((element) => element.isApplied == true) ==
                                                                              -1) {
                                                                            modDeleteDialog(context, 100, 'Delete Mods', 'Delete "$modsViewAppBarName ${modFilesList[index].first.iceParent}" and move it to \'Deleted Items\' folder?\nThis will also delete all files in this mod', true, modFilesList[index].first.modPath, modFilesList[index].first.iceParent, modFilesList[index].first.modName, modFilesList[index]).then((_) {
                                                                              setState(() {
                                                                                //setstate to refresh list
                                                                              });
                                                                            });
                                                                            ...
                                                                            List<ModFile>
                                                                                tempList =
                                                                                cateList[index].allModFiles.where((element) => element.modName == modFilesList[index].first.modName && element.isApplied == true).toList();
                                                                            List<String>
                                                                                stillAppliedList =
                                                                                [];
                                                                            double
                                                                      ...
                                                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                          ...
                                                                          content: SizedBox(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              crossAxisAlignment: CrossAxisAlignment.start,
                                                                              children: [
                                                                                for (int i = 0; i < backupFilesMissingList.length; i++) Text('Backup file of "${backupFilesMissingList[i].modName} ${backupFilesMissingList[i].iceParent} > ${backupFilesMissingList[i].iceName}" is not found'),
                                                                              ],
                                                                            ),
                                                                          )));
                                                                    }
                            ...
                            child: Column(
                              ...
                              children: [
                                if (_newModToItemDragDropList.isEmpty)
                                  const Center(
                                      child: Text(
                                          "Drop Modded .ice Files And Folder(s) Here To Add")),
              ...
              Padding(
                ...
                child: Container(
                    ...
                    child: totalAppliedItems < 2
                        ? Text(
                            '$totalAppliedItems Item | $totalAppliedFiles Files Applied',
                            style: const TextStyle(
                              fontSize: 13,
                            ))
                        : Text(
                            '$totalAppliedItems Items | $totalAppliedFiles Files Applied',
                            style: const TextStyle(
                              fontSize: 13,
                            ))),
              ),
                            ...
                            children: [
                              Container(
                                  ...
                                  child: setsList[setsList.indexWhere(
                                          ...
                                          2
                                      ? Text(
                                          '${setsList[setsList.indexWhere((element) => element.setName == item)].numOfItems} Item',
                                          style: const TextStyle(
                                            fontSize: 13,
                                          ))
                                      : Text(
                                          '${setsList[setsList.indexWhere((element) => element.setName == item)].numOfItems} Items',
                                          style: const TextStyle(
                                            fontSize: 13,
                                          ))),
                              const SizedBox(
                                                  ...
                                                  children: [
                                                    ...
                                                    if (appliedModsList.indexWhere(
                                                      ...
                                                      SizedBox(
                                                        ...
                                                        child: Tooltip(
                                                          message:
                                                              'Remove mods under "$modsViewAppBarName ${appliedModsList[index].first.iceParent}" from the game',
                                                          height: 25,
                                                          textStyle: TextStyle(
                                                              fontSize: 15,
                                                              color: Theme.of(
                        ...
                        ? (() {
                            if (newSetFormKey.currentState!.validate()) {
                              setsList.insert(
                                  0,
                                  ModSet(
                                      newSetTextController.text, 0, '', false));
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                                ...
                                                child: setsList[index]
                                                        ...
                                                        2
                                                    ? Text(
                                                        '${setsList[index].numOfItems} Item',
                                                        style: const TextStyle(
                                                          fontSize: 13,
                                                        ))
                                                    : Text(
                                                        '${setsList[index].numOfItems} Items',
                                                        style: const TextStyle(
                                                          fontSize: 13,
                                                        ))),
                                          ),
                                      ...
                                      trailing: Wrap(
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: Tooltip(
                                              ...
                                              waitDuration:
                                                  const Duration(seconds: 1),
                                              child: MaterialButton(
                                                onPressed: setsList[index].numOfItems < 1
                                                ? null
                                                : (() async {
                                                  isLoadingSetList[index] =
                                                      true;
                                                  modFilesFromSetList =
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              for (int i = 0; i < originalFilesMissingList.length; i++)
                                                                                Text('Original file of "${originalFilesMissingList[i].modName} ${originalFilesMissingList[i].iceParent} > ${originalFilesMissingList[i].iceName}" is not found'),
                                                                            ],
                                                                          ),
                                                                        )));
                                                          }
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              for (int i = 0; i < modAppliedDup.length; i++)
                                                                                Text('Replaced: ${modAppliedDup[i].categoryName} > ${modAppliedDup[i].modName} ${modAppliedDup[i].iceParent} > ${modAppliedDup[i].iceName}'),
                                                                            ],
                                                                          ),
                                                                        )));
                                                            modAppliedDup
                                          ...
                                          SizedBox(
                                            ...
                                            child: Tooltip(
                                                message:
                                                    'Remove ${setsList[index].setName} Set',
                                                height: 25,
                                                textStyle: TextStyle(
                                                    fontSize: 15,
                                                    color: Theme.of(context)
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(
                                                        ...
                                                        child: Tooltip(
                                                          message: modFilesFromSetList[
                                                                  ...
                                                                  .first
                                                                  .isFav
                                                              ? 'Remove "$modsViewAppBarName ${modFilesFromSetList[index].first.iceParent}" to favorites'
                                                      ...
                                                      if (modFilesFromSetList[
                                                        ...
                                                        SizedBox(
                                                          ...
                                                          child: Tooltip(
                                                            message:
                                                                'Remove all mods under "$modsViewAppBarName ${modFilesFromSetList[index].first.iceParent}" from the game',
                                                            height: 25,
                                                            textStyle: TextStyle(
                                                                fontSize: 15,
                                                                color: Theme.of(
                                                      ...
                                                      if (!isViewingFav)
                                                        Tooltip(
                                                            message:
                                                                'Delete $modsViewAppBarName ${modFilesFromSetList[index].first.iceParent}',
                                                            height: 25,
                                                            textStyle: TextStyle(
                                                                fontSize: 15,
                                                                color: Theme.of(
                                                              ...
                                                              child:
                                                                  MaterialButton(
                                                                      onPressed:
                                                                        ...
                                                                        setState(
                                                                            () {
                                                                          if (modFilesFromSetList[index].indexWhere((element) => element.isApplied == true) ==
                                                                              -1) {
                                                                            modDeleteDialog(context, 100, 'Delete Mods', 'Delete "$modsViewAppBarName ${modFilesFromSetList[index].first.iceParent}" and move it to \'Deleted Items\' folder?\nThis will also delete all files in this mod', true, modFilesFromSetList[index].first.modPath, modFilesFromSetList[index].first.iceParent, modFilesFromSetList[index].first.modName, modFilesFromSetList[index]).then((_) {
                                                                              setState(() {
                                                                                //setstate to refresh list
                                                                              });
                                                                            });
                                                                          } else if (modFilesFromSetList[index]
                                                                              .first
                                                                              .isFav) {
                                                                            double
                                                                                popupHeight =
                                                                            ...
                                                                            modDeleteDialog(
                                                                                ...
                                                                                popupHeight,
                                                                                'Delete Mod',
                                                                                'Cannot delete "$modsViewAppBarName ${modFilesFromSetList[index].first.iceParent}". Remove from Favorites first',
                                                                                false,
                                                                                modFilesFromSetList[index].first.modPath,
                                                                                modFilesFromSetList[index].first.iceParent,
                                                                                modFilesFromSetList[index].first.modName,
                                                                                []);
                                                                          } else {
                                                                            List<ModFile>
                                                                                tempList =
                                                                                cateList[index].allModFiles.where((element) => element.modName == modFilesFromSetList[index].first.modName && element.isApplied == true).toList();
                                                                            List<String>
                                                                                stillAppliedList =
                                                                                [];
                                                                            double
                                                                            ...
                                                                            modDeleteDialog(
                                                                                ...
                                                                                popupHeight,
                                                                                'Delete Mod',
                                                                                'Cannot delete "$modsViewAppBarName ${modFilesFromSetList[index].first.iceParent}". Unaplly these files first:\n\n$stillApplied',
                                                                                false,
                                                                                modFilesFromSetList[index].first.modPath,
                                                                                modFilesFromSetList[index].first.iceParent,
                                                                                modFilesFromSetList[index].first.modName,
