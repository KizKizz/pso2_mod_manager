                                                ...
                                                selectedMotionType.isNotEmpty || swapperSearchTextController.text.isNotEmpty || queueFromEmoteCsvFiles.isNotEmpty || queueToEmoteCsvFiles.isNotEmpty
                                                    ...
                                                    : () async {
                                                        ...
                                                        if (!isEmotesToStandbyMotions) {
                                                          ...
                                                          await sheetListFetchFromFiles(context, defaultCategoryDirs[14], widget.fromSubmod.getDistinctModFilePaths());
                                                          availableEmotesCsvData = await getEmotesToMotionsSwapToCsvList(csvEmotesData, defaultCategoryDirs[14]);
