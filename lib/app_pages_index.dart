...
int pageIndex = 0;
final List<Widget> appPages = [const AppGitHubAccessPage(), const LocalePage(), const AppUpdatePage(), const DataUpdatePage(), const OfficialDataFetchPage(), const PlayerDataLoadPage(), const AppPathPage(), const AppModLoadPage(), const AppModSetLoadPage(), const Homepage()];