    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.connectionState != ConnectionState.done) {
          ...
          return FutureBuilderError(loadingText: appText.fetchingNecessaryDirPaths, snapshotError: snapshot.error.toString(), isPopup: false, showContButton: false);
        } else {
                    ...
                    Visibility(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          spacing: 10,
                          children: [
                            ModManTooltip(message: appText.pso2binDirPathInfo, child: const Icon(Icons.info_outline)),
                            SizedBox(
                              width: 250,
                              child: TextField(
                    ...
                    Visibility(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          spacing: 10,
                          children: [
                            ModManTooltip(message: appText.mainDirPathInfo, child: const Icon(Icons.info_outline)),
                            SizedBox(
                              width: 250,
                              child: TextField(
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Text(appText.exit, style: const TextStyle(color: Colors.red)),
                        ),
                      ],
                    ),
                  ],
