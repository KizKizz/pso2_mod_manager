...
Signal<String> unappliedItemCheckStatus = Signal('');
...
class _AppAppliedModsLoadPageState extends State<AppAppliedModsLoadPage> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(appText.checkingAppliedMods, style: Theme.of(context).textTheme.bodyLarge),
                      ),
                    ],
                  ),
                ),
              ...
              child: Padding(
                ...
                child: CardOverlay(
                  ...
                  child: Column(
                    spacing: 10,
                    children: [
                      Center(child: Text(appText.restoredMods, style: Theme.of(context).textTheme.headlineMedium)),
                      const Divider(height: 0, thickness: 1.5, indent: 10, endIndent: 10),
                      Text(appText.restoredModInfo),
                      Expanded(child: ResponsiveGridList(minItemWidth: 320, children: unappliedItemWidgetsGet(masterUnappliedItemList))),
                      const Divider(height: 0, thickness: 1.5, indent: 10, endIndent: 10),
                      OverflowBar(
                        spacing: 5,
                        overflowSpacing: 5,
  ...
  List<Widget> unappliedItemWidgetsGet(List<Item> items) {
    List<Widget> widgets = [];
              ...
              CardOverlay(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible: mod.modName != submod.submodName,
                      child: Text(submod.submodName, textAlign: TextAlign.center, style: Theme.of(context).textTheme.labelLarge),
                    ),
                  ],
                ),
              ),
