    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.connectionState != ConnectionState.done) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(appText.loadingLineStrikeCards, style: Theme.of(context).textTheme.bodyLarge),
                  ),
                ],
              ),
            ),
          ...
          return FutureBuilderError(loadingText: appText.loadingLineStrikeCards, snapshotError: snapshot.error.toString(), isPopup: false, showContButton: true);
        } else {
