...
class AppText {
  ...
  String patchNotes = 'Patch Notes',
      ...
      successfullyRestoredFile = 'Successfully removed "%p%"',
      failedToRestoredFile = 'Failed to remove "%p%"',
  ...
  String failedToFetchRemoteLocaleData = 'Failed to fetch remote locale data',
      ...
      restoredVitalGauges = 'Removed Custom Vital Gauges',
      restoredAQMInjectedItems = 'Removed AQM Injected Items';
  ...
  String pso2binDirPathInfo = 'PSO2 game data folder, this folder located inside the game installation directory',
      ...
      restoredModInfo = 'These mods have been removed by game update or file check',
      restoredVitalGaugeInfo = 'These Custom Vital Gauge backgrounds have been removed by game update or file check',
      restoredAQMInjectedItemInfo = 'Custom AQM and Bounding Radius of these items have been removed by game update or file check',
