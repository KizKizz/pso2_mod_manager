...
AppText _$AppTextFromJson(Map<String, dynamic> json) => AppText()
  ...
  ..unknownItem = json['unknownItem'] as String
  ...
  ..holdToRemoveAllMods = json['holdToRemoveAllMods'] as String
  ...
  ..checkingAppVersion = json['checkingAppVersion'] as String
  ..newAppVersionFound = json['newAppVersionFound'] as String
  ..extractingDownloadedZipFile = json['extractingDownloadedZipFile'] as String
  ..extractCompletedReadyToPatch =
  ...
  ..missingPathsFound = json['missingPathsFound'] as String
...
Map<String, dynamic> _$AppTextToJson(AppText instance) => <String, dynamic>{
  ...
  'unknownItem': instance.unknownItem,
  ...
  'holdToRemoveAllMods': instance.holdToRemoveAllMods,
  ...
  'checkingAppVersion': instance.checkingAppVersion,
  'newAppVersionFound': instance.newAppVersionFound,
  'extractingDownloadedZipFile': instance.extractingDownloadedZipFile,
  ...
  'missingPathsFound': instance.missingPathsFound,
  ...
  'browseDownloadedItemDataLocation': instance.browseDownloadedItemDataLocation,
  ...
  'firstTimeHomepageStyleSelectInfo': instance.firstTimeHomepageStyleSelectInfo,
