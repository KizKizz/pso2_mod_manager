...
Future<(List<ModSet>, List<ModSet>)> modToSetPopup(context, SubMod submod) async {
  List<ModSet> modsetsToAdd = [];
  List<ModSet> modsetsToRemove = [];
  modsetsToAdd.addAll(masterModSetList.where((e) => submod.setNames.contains(e.setName)));
      ...
      return StatefulBuilder(
        builder: (dialogContext, setState) {
          return AlertDialog(
            ...
            title: Column(
              children: [
                Text(submod.submodName, style: TextStyle(color: Theme.of(context).colorScheme.primary)),
                const HoriDivider(),
              ],
            ),
