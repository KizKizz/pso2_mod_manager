...
List<Widget> homepageWidgets = [const MainItemGrid(), const MainModGrid(), const MainAppliedModGrid(), const MainModSetGrid(), const MainItemSwapGrid(), const MainItemAqmInjectGrid(), const ModAdd(), const Settings()];
