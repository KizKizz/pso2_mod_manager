...
void aqmInjectionDialog(context) {
  showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
            ...
            content: CardBanner(
              ...
              padding: 2,
              edgeSize: 0,
              child: SizedBox(width: MediaQuery.of(context).size.width * 0.8, height: MediaQuery.of(context).size.height, child: const AqmInjectionHomePage()),
            ));
      });
}
