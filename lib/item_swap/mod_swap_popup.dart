        ...
        builder: (context) => StatefulBuilder(
          builder: (dialogContext, setState) {
            displayingItems = pItemData
                ...
                .where(
                  (e) => submod.category == defaultCategoryDirs[1]
                      ? e.subCategory == 'Basewear'
                      : submod.category == defaultCategoryDirs[16]
                      ? e.subCategory == 'Setwear'
                      : submod.category == defaultCategoryDirs[14]
                      ? e.category == submod.category && (e.subCategory == selectedItemSwapMotionType.value || selectedItemSwapMotionType.value == appText.all)
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        if (submod.category == defaultCategoryDirs[14])
                          Expanded(
                  ...
                  children: [
                    OverflowBar(
                      ...
                      children: [
                        ...
                        if (submod.category == defaultCategoryDirs[1] ||
