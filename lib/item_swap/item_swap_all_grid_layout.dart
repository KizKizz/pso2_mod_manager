                    ...
                    child: ListTile(
                      ...
                      title: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(displayingItemData[index].getName(), style: const TextStyle(fontWeight: FontWeight.w500)),
                          ),
                        ],
                      ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 2,
                                    child: InfoBox(info: appText.dText(appText.numItemSelected, widget.selectedSubmods.value.length.toString()), borderHighlight: widget.item.applyStatus),
                                  ),
                                ],
                              ),
                            ],
                          ...
                          children: [
                            Visibility(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  SubmodPreviewBox(
                                    imageFilePaths: displayingSubmods[index].previewImages,
                                    videoFilePaths: displayingSubmods[index].previewVideos,
                                    isNew: displayingSubmods[index].isNew,
                                  ),
                                  Visibility(
                                    visible:
                                        displayingSubmods[index].hasCmx! ||
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Visibility(
                                            ...
                                            child: InfoTag(info: appText.cmx, borderHighlight: displayingSubmods[index].cmxApplied!),
                                          ),
                                          Visibility(
                            ...
                            Row(
                              ...
                              children: [
                                Flexible(
                                  child: Text(displayingSubmods[index].modName, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleSmall),
                                ),
                                const Icon(Icons.arrow_right),
                                Flexible(
                                  child: Text(displayingSubmods[index].submodName, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleSmall),
                                ),
                              ],
                            ),
                            SizedBox(
