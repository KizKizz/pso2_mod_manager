...
List<XFile> modsImportDragDropFiles = [];
...
void modsImporterHomePage(context) {
                      ...
                      children: [
                        ...
                        SizedBox(
                            width: dropZoneMax
                                ...
                                : modsImportDragDropFiles.isEmpty
                                ...
                                DropTarget(
                                  ...
                                  onDragDone: (detail) async {
                                    for (var element in detail.files) {
                                      ...
                                      } else if (modsImportDragDropFiles.indexWhere((file) => file.path == element.path) == -1) {
                                        modsImportDragDropFiles.add(element);
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            if (modsImportDragDropFiles.isEmpty)
                                              Center(
                                                  child: Text(
                                            ...
                                            if (modsImportDragDropFiles.isNotEmpty)
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: ListView.builder(
                                                            itemCount: modsImportDragDropFiles.length,
                                                            itemBuilder: (BuildContext context, int index) {
                                                              return ListTile(
                                                                ...
                                                                trailing: SizedBox(
                                                                  ...
                                                                  child: ModManTooltip(
                                                                    ...
                                                                    child: MaterialButton(
                                                                      ...
                                                                      onPressed: () {
                                                                        modsImportDragDropFiles.removeAt(index);
                                                                        setState(
                                                                          () {},
                                                                        );
                                                                      },
                                                                ...
                                                                title: Text(modsImportDragDropFiles[index].name),
                                                                subtitle: Text(
                                                                  modsImportDragDropFiles[index].path,
                                                                  maxLines: 1,
                                            ...
                                            child: ElevatedButton(
                                                onPressed: (() async {
                                                  ...
                                                  if (selectedDirPaths.isNotEmpty) {
                                                    modsImportDragDropFiles.addAll(selectedDirPaths.map((e) => XFile(e!)));
                                                  }
                                                  setState(
                                                    () {},
                                                  );
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: ElevatedButton(
                                                onPressed: (() async {
                                                  ...
                                                  if (selectedDirPaths.isNotEmpty) {
                                                    modsImportDragDropFiles.addAll(selectedDirPaths.map((e) => e!));
                                                  }
                                                  setState(
                                                    () {},
                                                  );
                                ...
                                SizedBox(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ElevatedButton(
                                            onPressed: modsImportDragDropFiles.isNotEmpty
                                                ? (() {
                                                    modsImportDragDropFiles.clear();
                                          ...
                                          child: ElevatedButton(
                                              ...
                                              onPressed: modsImportDragDropFiles.isNotEmpty
                                                  ? (() async {
                                                      ...
                                                      processedImportedFileListLoad = modsAdderFilesProcess(context, modsImportDragDropFiles.toList());
                                                      modsImportDragDropFiles.clear();
                                                      dropZoneMax = false;
                                                      setState(
                                                        () {},
                                        ...
                                        if (snapshot.hasError) {
                                          ...
                                          if (_itemNameRenameIndex.isEmpty || _itemNameRenameIndex.length != processedFileList.length || renameModDifferencesFound) {
                                            ...
                                            subFoldersRenameIndex = List.generate(
                                                ...
                                                (index) => List.generate(
                                                    processedFileList[index].modList.length, (mIndex) => List.generate(processedFileList[index].modList[mIndex].submodList.length, (sIndex) => false)));
                                          }
                                          //misc dropdown
...
Future<List<ModsAdderItem>> modsImportFilesProcess(context, List<XFile> xFilePaths) async {
  ...
  for (var rootDir in extractedImportDirs) {
    for (var cate in rootDir.listSync().whereType<Directory>()) {
      String itemCategory = defaultCategoryNames[defaultCategoryDirs.indexOf(p.basename(cate.path))];
