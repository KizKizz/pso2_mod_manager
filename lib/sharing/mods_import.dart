...
import 'package:pso2_mod_manager/sharing/mod_export_add_function.dart';
                                                    ...
                                                    child: ElevatedButton(
                                                        ...
                                                        onPressed: modAdderDragDropFiles.isNotEmpty
                                                            ? (() async {
                                                                ...
                                                                processedFileListLoad = modsImportFilesProcess(context, modAdderDragDropFiles.toList());
                                                                modAdderDragDropFiles.clear();
                                                                dropZoneMax = false;
                                                                setState(
                                                                  () {},
                                                        ...
                                                        onPressed: processedFileList.isEmpty ||
                                                            ...
                                                            : (() async {
                                                                if (_duplicateCounter > 0) {
                                                                  ...
                                                                  // ignore: use_build_context_synchronously
                                                                  modsImportFilesAdder(context, toAddList, await newImportModSetDialog(context)).then(
                                                                    (value) {
                                                                      if (value) {
                                                                        //clear values
                                                                        clearAllTempDirs();
