...
class TranslationText {
  ...
  String uiPso2binFolderNotFoundSelect = 'pso2_bin folder not found. Select it now?',
      ...
      uiWindowsStoreVerNote = 'If you are playing on Windows Store version, it might be "Content" instead of "pso2_bin" folder';
...
//mods_swapper_homepage
  ...
  String uiCustomCardImages = 'Custom Card Images',
      ...
      uiCardExport = 'Card Export',
      uiExportCustomizedCardToPng = 'Export this card to png image',
      uiOpenExportedCardFolder = 'Open Exported Cards Folder',
      ...
      uiCardIce = 'Ice',
      uiCardWind = 'Wind',
      uiCardLightning = 'Lightning',
      uiCardLight = 'Light',
      uiCardDark = 'Dark',
      uiCardElementSelect = 'Card Element Select',
      uiUnableToDetectTheElementOfThisCard = 'Unable to detect the element of this card\nPlease select the correct element',
      uiCardElement = 'Card Element';
